...
class PessoasSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pessoas = [
            ...
            ['nome' => 'Cristina Lozano Serra', 'departamentoID' => 2, 'disponibilidade' => true, 'endereco' => $endereco[4], 'telefone' => $telefone[4], 'cpfcnpj' => $cpf[4], 'created_at' => now(), 'updated_at' => now()],
            ['nome' => 'Marta Patrícia Grego Neto', 'departamentoID' => 3, 'disponibilidade' => true, 'endereco' => $endereco[5], 'telefone' => $telefone[5], 'cpfcnpj' => $cpf[5], 'created_at' => now(), 'updated_at' => now()],
            ['nome' => 'Eloá Antonella Caldeira', 'departamentoID' => 4, 'disponibilidade' => true, 'endereco' => $endereco[6], 'telefone' => $telefone[6], 'cpfcnpj' => $cpf[6], 'created_at' => now(), 'updated_at' => now()],
            ['nome' => 'Jennifer Teles Velasques', 'departamentoID' => 5, 'disponibilidade' => true, 'endereco' => $endereco[7], 'telefone' => $telefone[7], 'cpfcnpj' => $cpf[7], 'created_at' => now(), 'updated_at' => now()],
